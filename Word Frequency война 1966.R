# Frequency of война in 1966

rm(list = ls()) # Clear Workspace

text_v <- scan("C:/Users/singi/Desktop/HSL/R Studio/Project/NEW_Texts/combined_text_1966.txt", what = "character", sep = "\n")
length(text_v)
...
plot(
  в_count_v,
  main = "Dispersion Plot of 'война' in 1966",
  xlab = "Issue Time",
  ylab = "война",
  type = "h",
  ylim = c(0, 1), yaxt = 'n'
